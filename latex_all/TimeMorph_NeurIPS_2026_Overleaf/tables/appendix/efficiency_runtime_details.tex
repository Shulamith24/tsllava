...
\begin{table}[t]
\centering
\caption{Printed per-dataset runtime details for the computational-efficiency probe on ACSF1, one dataset from the representative UCR runtime subset. Aggregate runtime and memory statistics over the representative subset are reported in Tables~\ref{tab:efficiency-compact} and \ref{tab:computational-efficiency}.}
