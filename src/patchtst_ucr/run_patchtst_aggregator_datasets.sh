#!/bin/bash
# ==============================================================================
# PatchTST + Aggregator UCR 全数据集批量训练脚本
# 
# 用法：可在任意路径下执行此脚本
#   bash /path/to/run_patchtst_aggregator_datasets.sh
# ==============================================================================
...
echo "============================================================"
echo "PatchTST + Aggregator UCR 批量训练"
echo "============================================================"
...
# Aggregator 配置
AGGREGATOR_LAYERS=1
# AGGREGATOR_HIDDEN_SIZE=  # 留空表示使用默认值(与d_model相同)
# FREEZE_BACKBONE=false    # 设为true则添加 --freeze_backbone 参数
...
echo "Aggregator 层数: $AGGREGATOR_LAYERS"
echo ""
